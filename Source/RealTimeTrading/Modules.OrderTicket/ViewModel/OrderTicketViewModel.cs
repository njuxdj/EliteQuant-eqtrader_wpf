...
namespace Modules.OrderTicket.ViewModel
{
    public class OrderTicketViewModel : BindableBase
    {
        ...
        int _selectedSecurityType;
        public int SelectedSecurityType
        {
            get { return _selectedSecurityType; }
            set
            {
                SetProperty(ref _selectedSecurityType, value);
            }
        }
        ...
        int _selectedOrderFlag;
        public int SelectedOrderFlag
        {
            get { return _selectedOrderFlag; }
            set
            {
                SetProperty(ref _selectedOrderFlag, value);
            }
        }
